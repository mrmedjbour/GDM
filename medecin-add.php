<?php
define('PAGETITLE', 'Ajouter un médecin');
include './includes/head.php';

?>
            <div class="container-fluid">
                <h3 class="text-dark mb-4">Ajouter médecin</h3>
                <div class="row mb-3">
                    <div class="col-12">
                        <div class="row">
                            <div class="col">
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        <form id="addDoctor" action="medecin-add.php" method="post">
                                            <div class="form-row">
                                                <div class="col">
                                            ...
                                            <div class="form-group"><button class="btn btn-primary" type="submit"  value="addDr" name="addDr">Ajouter</button></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
