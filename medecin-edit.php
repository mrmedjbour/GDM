<?php
define('PAGETITLE', 'Modifier le profil médecin');
include './includes/head.php';

$stmt = $db->prepare("SELECT * 
                            FROM users 
                            WHERE id = ? AND profil_type='medecin'");
...
<div class="container-fluid">
    <h3 class="text-dark mb-4">Modifier le profil médecin</h3>
    <div class="row mb-3">
        <div class="col-12">
            <div class="row">
                <div class="col">
                    <div class="card shadow mb-3">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Médecin</p>
                        </div>
                        <div class="card-body">
                            <form id="addDoctor" action="medecin-edit.php?id=<?php echo $dr['id'];?>" method="post">
                                ...
                                <div class="form-group"><button class="btn btn-primary" type="submit"  value="addDr" name="editDr">Modifier</button></div>
                            </form>
                        </div>
                    </div>
                </div>
